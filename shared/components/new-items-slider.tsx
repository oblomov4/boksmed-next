...
export const NewItemsSlider: React.FC<Props> = ({ className }) => {
  if (className) {
    console.log('Исправлю потом');
  }
      ...
      <Swiper
        ...
        <SwiperSlide>
          <div className="new__box">
            ...
            <h3 className="new__box-title">АВТОМАТИЧЕСКИЙ ДЕФИБРИЛЛЯТОР PRIMEDIC HEARTSAVE PAD</h3>
